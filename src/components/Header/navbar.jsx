            ...
            <section className={n.section}>
                <div className="container">
                    <nav className={n.navbar}>
                        ...
                        <NavLink to="/users" className={n.item} activeClassName={n.active}><i className="fas fa-comments"></i> Find users</NavLink>                        {/*<a href="#" className={n.item}><i className="fa fa-newspaper"></i> News</a>*/}
